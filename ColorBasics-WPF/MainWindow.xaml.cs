...
namespace Microsoft.Samples.Kinect.ColorBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private ColorImagePoint[] colorImagePointArray;
        ...
        private System.Windows.Controls.Image colImage;
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null != this.sensor)
            {
                ...
                colImage = new System.Windows.Controls.Image();
                skelImage = new System.Windows.Controls.Image();
                // Set the image we display to point to the bitmap where we'll put the image data
                colImage.Source = this.colorBitmap;
                this.imageSource = new DrawingImage(this.drawingGroup);
                skelImage.Source = this.imageSource;
                ...
                colorImagePointArray = new ColorImagePoint[this.sensor.ColorStream.FrameWidth * this.sensor.ColorStream.FrameHeight];
        ...
        private void SensorColorFrameReady(object sender, ColorImageFrameReadyEventArgs e)
        {
            ...
            {
                if (colorFrame != null && skelDrawn != 0)
                {
